...
atari_muzero_config = dict(
    exp_name=f'data_mz_ctree/z3_game_2048_muzero_ns_adamw02{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_bs{batch_size}_sslw2_rew-morm-true_seed0',
    env=dict(
        stop_value=int(1e6),
        env_name=env_name,
        obs_shape=(16, 4, 4),
