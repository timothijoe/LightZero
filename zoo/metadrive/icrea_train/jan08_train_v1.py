...
pendulum_sampled_efficientzero_config = dict(
    exp_name=
    f'data_icra_dec31_ctree/t1aec_mcts_k{K}_ns{num_simulations}_upc{update_per_collect}_rr{reanalyze_ratio}_expert_seed0',
    env=dict(
        env_name='taec_mcts',
        continuous=True,
        obs_shape = [5, 200, 200],
    ...
    policy=dict(
        ...
        threshold_training_steps_for_final_temperature = 40000, #20000
        threshold_training_steps_for_final_lr = 40000, #20000
