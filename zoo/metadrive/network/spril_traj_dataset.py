...
class SPIRLDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        return self.extract_data[str(index)]['observation']['birdview'].transpose((2, 0, 1)), self.extract_data[str(index)]['observation']['vehicle_state'], self.extract_data[str(index)]['trajectory'] 