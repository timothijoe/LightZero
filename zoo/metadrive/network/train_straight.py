...
expert_dir = '/home/hunter/obelisk/ss/expcc_straight/'
expert_dir = '/home/hunter/obelisk/ss/inter'
expert_dir = '/home/hunter/obelisk/ss/roundabout'
...
metadrive_basic_config = dict(
    ...
    exp_name = 'sep14_metadrive_zt_round',
    policy=dict(
        cuda=True,
        model=dict(
            obs_shape=[5, 200, 200],
