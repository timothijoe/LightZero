...
PATH_LIBRARY_PATH = pwd + '/data_folder/path_matfiles/'
    ...
    for degree in degree_list:
        ...
        for path in path_list:
            if path is not None:
                ...
                path_id += 1 
        mat_name = PATH_LIBRARY_PATH +"len" + str(dd)+"degree" + str(degree) + "mat.mat"   
...
#     #lane_state_sampling_test4()
#     lane_state_sampling_one_case(0)
#     lane_state_sampling_one_case(5)
#     lane_state_sampling_one_case(10)
#     lane_state_sampling_one_case(15)
#     lane_state_sampling_one_case(20)
#     lane_state_sampling_one_case(25)
#     lane_state_sampling_one_case(30)
#     lane_state_sampling_one_case(35)
#     lane_state_sampling_one_case(40)
#     lane_state_sampling_one_case(45)
#     lane_state_sampling_one_case(50)
#     lane_state_sampling_one_case(55)
#     lane_state_sampling_one_case(60)
#     degree_list = [-60, -50, -40, -30, -20, -10, 0, 10, 20, 30, 40, 50, 60]
#     for degree in degree_list:
#         print('preparing degree {}'.format(degree))
#         path_dictionary = {}
#         path = lane_state_sampling_one_case(degree)
#         if path is not None:
#             path_dictionary[str(path_id)] = copy.deepcopy(path)
#             path_id += 1 
#         mat_name = PATH_LIBRARY_PATH + "degree" + str(degree) + "mat.mat"   
#         mat_name = PATH_LIBRARY_PATH + "five_lane_change_path" + "mat.mat"  
#         io.savemat(mat_name, path_dictionary) 
