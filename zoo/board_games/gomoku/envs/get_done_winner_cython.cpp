...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "include_dirs": [
            "/tmp/pip-build-env-454q0t7s/overlay/lib/python3.8/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "name": "zoo.board_games.gomoku.envs.get_done_winner_cython",
        "sources": [
            "/home/zhoutong/osiris/LightZero/zoo/board_games/gomoku/envs/get_done_winner_cython.pyx"
        ]
    },
