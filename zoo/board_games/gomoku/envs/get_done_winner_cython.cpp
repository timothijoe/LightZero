...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "include_dirs": [
            "/tmp/pip-build-env-vuxnx3rw/overlay/lib/python3.8/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "name": "zoo.board_games.gomoku.envs.get_done_winner_cython",
        "sources": [
            "/home/PJLAB/puyuan/osiris/develop-lz/zoo/board_games/gomoku/envs/get_done_winner_cython.pyx"
        ]
    },
    "module_name": "zoo.board_games.gomoku.envs.get_done_winner_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__zoo__board_games__gomoku__envs__get_done_winner_cython
...
static const char *__pyx_f[] = {
  "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx",
  "stringsource",
};
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_int32_t(PyObject *, int writable_flag);
...
/* Module declarations from 'zoo.board_games.gomoku.envs.get_done_winner_cython' */
...
static PyObject *__pyx_f_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(int32_t, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "zoo.board_games.gomoku.envs.get_done_winner_cython"
extern int __pyx_module_is_main_zoo__board_games__gomoku__envs__get_done_winner_cython;
int __pyx_module_is_main_zoo__board_games__gomoku__envs__get_done_winner_cython = 0;

/* Implementation of 'zoo.board_games.gomoku.envs.get_done_winner_cython' */
...
static PyObject *__pyx_pf_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(CYTHON_UNUSED PyObject *__pyx_self, int32_t __pyx_v_board_size, __Pyx_memviewslice __pyx_v_board); /* proto */
...
/* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":6
 * @cython.boundscheck(False)  # Disable bounds checking for better performance
 * @cython.wraparound(False)  # Disable negative indexing for better performance
 * cpdef get_done_winner_cython(int32_t board_size, int32_t[:, :] board):             # <<<<<<<<<<<<<<
 *     """
 *     Overview:
 */

static PyObject *__pyx_pw_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_1get_done_winner_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(int32_t __pyx_v_board_size, __Pyx_memviewslice __pyx_v_board, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int32_t __pyx_v_i;
  int32_t __pyx_v_j;
  int32_t __pyx_v_player;
  int32_t __pyx_v_x;
  int32_t __pyx_v_y;
  int32_t __pyx_v_count;
  int __pyx_v_has_legal_actions;
  PyObject *__pyx_v_directions = 0;
  long __pyx_v_start_dir_idx;
  long __pyx_v_end_dir_idx;
  long __pyx_v_d_idx;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("get_done_winner_cython", 0);

  /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":21
 *     """
 ...
 */
  __pyx_v_has_legal_actions = 0;

  /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":23
 *     cdef bint has_legal_actions = False
 *     # Check for a winning condition in all 4 directions: diagonal left, horizontal, diagonal right, and vertical
 *     cdef directions = ((1, -1), (1, 0), (1, 1), (0, 1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_v_directions = __pyx_tuple__5;

  /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":26
 * 
 *     # iterate through all positions in the board
 ...
 */
  __pyx_t_1 = __pyx_v_board_size;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":27
 *     # iterate through all positions in the board
 *     for i in range(board_size):
 *         for j in range(board_size):             # <<<<<<<<<<<<<<
 *             # If the position is empty, there are still legal actions available
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":29
 *         for j in range(board_size):
 *             # If the position is empty, there are still legal actions available
 *             if board[i, j] == 0:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      __pyx_t_9 = (((*((int32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board.data + __pyx_t_7 * __pyx_v_board.strides[0]) ) + __pyx_t_8 * __pyx_v_board.strides[1]) ))) == 0) != 0);
      if (__pyx_t_9) {

        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":30
 *             # If the position is empty, there are still legal actions available
 *             if board[i, j] == 0:
 *                 has_legal_actions = True             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
        __pyx_v_has_legal_actions = 1;

        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":31
 *             if board[i, j] == 0:
 *                 has_legal_actions = True
 *                 continue             # <<<<<<<<<<<<<<
 *             # Store the player number (1 or 2) of the current position
 ...
 */
      ...
      /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":33
 *                 continue
 *             # Store the player number (1 or 2) of the current position
 *             player = board[i, j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_8 = __pyx_v_i;
      __pyx_t_7 = __pyx_v_j;
      __pyx_v_player = (*((int32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board.data + __pyx_t_8 * __pyx_v_board.strides[0]) ) + __pyx_t_7 * __pyx_v_board.strides[1]) )));

      /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":40
 * 
 *             # Determine which directions to check based on the current position
 *             start_dir_idx = 0 if j > 0 else 1             # <<<<<<<<<<<<<<
 *             end_dir_idx = 4 if j < board_size - 1 else 3
 ...
 */
      ...
      __pyx_v_start_dir_idx = __pyx_t_10;

      /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":41
 *             # Determine which directions to check based on the current position
 *             start_dir_idx = 0 if j > 0 else 1
 *             end_dir_idx = 4 if j < board_size - 1 else 3             # <<<<<<<<<<<<<<
 *             for d_idx in range(start_dir_idx, end_dir_idx):
 *                 d = directions[d_idx]
 */
      if (((__pyx_v_j < (__pyx_v_board_size - 1)) != 0)) {
        __pyx_t_10 = 4;
      } else {
        __pyx_t_10 = 3;
      }
      __pyx_v_end_dir_idx = __pyx_t_10;

      /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":42
 *             start_dir_idx = 0 if j > 0 else 1
 *             end_dir_idx = 4 if j < board_size - 1 else 3
 *             for d_idx in range(start_dir_idx, end_dir_idx):             # <<<<<<<<<<<<<<
 *                 d = directions[d_idx]
 * 
 */
      __pyx_t_10 = __pyx_v_end_dir_idx;
      __pyx_t_11 = __pyx_t_10;
      for (__pyx_t_12 = __pyx_v_start_dir_idx; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        __pyx_v_d_idx = __pyx_t_12;

        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":43
 *             end_dir_idx = 4 if j < board_size - 1 else 3
 *             for d_idx in range(start_dir_idx, end_dir_idx):
 *                 d = directions[d_idx]             # <<<<<<<<<<<<<<
 * 
 *                 x, y = i, j
 */
        __pyx_t_13 = __Pyx_GetItemInt(__pyx_v_directions, __pyx_v_d_idx, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 43, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __Pyx_XDECREF_SET(__pyx_v_d, __pyx_t_13);
        __pyx_t_13 = 0;

        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":45
 *                 d = directions[d_idx]
 * 
 *                 x, y = i, j             # <<<<<<<<<<<<<<
 *                 count = 0
 ...
 */
        ...
        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":46
 * 
 *                 x, y = i, j
 *                 count = 0             # <<<<<<<<<<<<<<
 * 
 *                 # Skip the direction if there is not enough space to form a line of 5
 */
        __pyx_v_count = 0;

        /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":49
 * 
 *                 # Skip the direction if there is not enough space to form a line of 5
 *                 if (0 <= x + 4 * d[0] < board_size) and (0 <= y + 4 * d[1] < board_size):             # <<<<<<<<<<<<<<
 * 
 *                     # Check for 5 consecutive positions with the same player number
 */
        __pyx_t_13 = __Pyx_PyInt_From_int32_t(__pyx_v_x); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __pyx_t_16 = __Pyx_GetItemInt(__pyx_v_d, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_17 = PyNumber_Multiply(__pyx_int_4, __pyx_t_16); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_17);
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        __pyx_t_16 = PyNumber_Add(__pyx_t_13, __pyx_t_17); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
        __pyx_t_17 = PyObject_RichCompare(__pyx_int_0, __pyx_t_16, Py_LE); __Pyx_XGOTREF(__pyx_t_17); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 49, __pyx_L1_error)
        if (__Pyx_PyObject_IsTrue(__pyx_t_17)) {
          __Pyx_DECREF(__pyx_t_17);
          __pyx_t_13 = __Pyx_PyInt_From_int32_t(__pyx_v_board_size); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_13);
          __pyx_t_17 = PyObject_RichCompare(__pyx_t_16, __pyx_t_13, Py_LT); __Pyx_XGOTREF(__pyx_t_17); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        }
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        __pyx_t_18 = __Pyx_PyObject_IsTrue(__pyx_t_17); if (unlikely(__pyx_t_18 < 0)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
        if (__pyx_t_18) {
        } else {
        ...
        __pyx_t_17 = __Pyx_PyInt_From_int32_t(__pyx_v_y); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_17);
        __pyx_t_16 = __Pyx_GetItemInt(__pyx_v_d, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_13 = PyNumber_Multiply(__pyx_int_4, __pyx_t_16); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        __pyx_t_16 = PyNumber_Add(__pyx_t_17, __pyx_t_13); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __pyx_t_13 = PyObject_RichCompare(__pyx_int_0, __pyx_t_16, Py_LE); __Pyx_XGOTREF(__pyx_t_13); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 49, __pyx_L1_error)
        if (__Pyx_PyObject_IsTrue(__pyx_t_13)) {
          __Pyx_DECREF(__pyx_t_13);
          __pyx_t_17 = __Pyx_PyInt_From_int32_t(__pyx_v_board_size); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_17);
          __pyx_t_13 = PyObject_RichCompare(__pyx_t_16, __pyx_t_17, Py_LT); __Pyx_XGOTREF(__pyx_t_13); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 49, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
        }
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
        __pyx_t_18 = __Pyx_PyObject_IsTrue(__pyx_t_13); if (unlikely(__pyx_t_18 < 0)) __PYX_ERR(0, 49, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __pyx_t_9 = __pyx_t_18;
        __pyx_L11_bool_binop_done:;
        if (__pyx_t_9) {

          /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":52
 * 
 *                     # Check for 5 consecutive positions with the same player number
 *                     for _ in range(5):             # <<<<<<<<<<<<<<
 ...
 */
          for (__pyx_t_19 = 0; __pyx_t_19 < 5; __pyx_t_19+=1) {
            ...
            /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":54
 *                     for _ in range(5):
 *                         # If the current position is out of the board's boundaries, break the loop
 *                         if x < 0 or x >= board_size or y < 0 or y >= board_size:             # <<<<<<<<<<<<<<
 *                             break
 ...
 */
            ...
            __pyx_t_18 = ((__pyx_v_x >= __pyx_v_board_size) != 0);
            if (!__pyx_t_18) {
            } else {
              __pyx_t_9 = __pyx_t_18;
              goto __pyx_L16_bool_binop_done;
            ...
            __pyx_t_18 = ((__pyx_v_y >= __pyx_v_board_size) != 0);
            __pyx_t_9 = __pyx_t_18;
            __pyx_L16_bool_binop_done:;
            if (__pyx_t_9) {

              /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":55
 *                         # If the current position is out of the board's boundaries, break the loop
 *                         if x < 0 or x >= board_size or y < 0 or y >= board_size:
 *                             break             # <<<<<<<<<<<<<<
 *                         # If the current position doesn't have the same player number, break the loop
 ...
 */
            ...
            /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":57
 *                             break
 *                         # If the current position doesn't have the same player number, break the loop
 *                         if board[x, y] != player:             # <<<<<<<<<<<<<<
 *                             break
 ...
 */
            __pyx_t_7 = __pyx_v_x;
            __pyx_t_8 = __pyx_v_y;
            __pyx_t_9 = (((*((int32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board.data + __pyx_t_7 * __pyx_v_board.strides[0]) ) + __pyx_t_8 * __pyx_v_board.strides[1]) ))) != __pyx_v_player) != 0);
            if (__pyx_t_9) {

              /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":58
 *                         # If the current position doesn't have the same player number, break the loop
 *                         if board[x, y] != player:
 *                             break             # <<<<<<<<<<<<<<
 *                         # Move to the next position in the direction and increment the count
 ...
 */
            ...
            /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":60
 *                             break
 *                         # Move to the next position in the direction and increment the count
 *                         x += d[0]             # <<<<<<<<<<<<<<
 *                         y += d[1]
 *                         count += 1
 */
            __pyx_t_13 = __Pyx_PyInt_From_int32_t(__pyx_v_x); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 60, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_13);
            __pyx_t_16 = __Pyx_GetItemInt(__pyx_v_d, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 60, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_16);
            __pyx_t_17 = PyNumber_InPlaceAdd(__pyx_t_13, __pyx_t_16); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 60, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_17);
            __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
            __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
            __pyx_t_15 = __Pyx_PyInt_As_int32_t(__pyx_t_17); if (unlikely((__pyx_t_15 == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
            __pyx_v_x = __pyx_t_15;

            /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":61
 *                         # Move to the next position in the direction and increment the count
 *                         x += d[0]
 *                         y += d[1]             # <<<<<<<<<<<<<<
 *                         count += 1
 *                         # If 5 consecutive positions with the same player number are found, return 'done' as True and the 'winner' as the player number
 */
            __pyx_t_17 = __Pyx_PyInt_From_int32_t(__pyx_v_y); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 61, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_17);
            __pyx_t_16 = __Pyx_GetItemInt(__pyx_v_d, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 61, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_16);
            __pyx_t_13 = PyNumber_InPlaceAdd(__pyx_t_17, __pyx_t_16); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 61, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_13);
            __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
            __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
            __pyx_t_15 = __Pyx_PyInt_As_int32_t(__pyx_t_13); if (unlikely((__pyx_t_15 == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 61, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
            __pyx_v_y = __pyx_t_15;

            /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":62
 *                         x += d[0]
 *                         y += d[1]
 *                         count += 1             # <<<<<<<<<<<<<<
 *                         # If 5 consecutive positions with the same player number are found, return 'done' as True and the 'winner' as the player number
 ...
 */
            ...
            /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":64
 *                         count += 1
 *                         # If 5 consecutive positions with the same player number are found, return 'done' as True and the 'winner' as the player number
 *                         if count == 5:             # <<<<<<<<<<<<<<
 *                             return True, player
 * 
 */
            __pyx_t_9 = ((__pyx_v_count == 5) != 0);
            if (__pyx_t_9) {

              /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":65
 *                         # If 5 consecutive positions with the same player number are found, return 'done' as True and the 'winner' as the player number
 *                         if count == 5:
 *                             return True, player             # <<<<<<<<<<<<<<
 * 
 ...
 */
              ...
              __pyx_t_13 = __Pyx_PyInt_From_int32_t(__pyx_v_player); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 65, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_13);
              __pyx_t_16 = PyTuple_New(2); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 65, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_16);
              __Pyx_INCREF(Py_True);
              __Pyx_GIVEREF(Py_True);
              PyTuple_SET_ITEM(__pyx_t_16, 0, Py_True);
 ...
 */
  ...
  /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":68
 * 
 *     # If no legal actions are left, return 'done' as True and 'winner' as -1 (draw)
 *     return not has_legal_actions, -1             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_16 = __Pyx_PyBool_FromLong((!(__pyx_v_has_legal_actions != 0))); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
 ...
 */
  ...
  __Pyx_AddTraceback("zoo.board_games.gomoku.envs.get_done_winner_cython.get_done_winner_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_1get_done_winner_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython[] = "\n    Overview:\n         Check if the gomoku game is over and who the winner is. Return 'done' and 'winner'.\n    Arguments:\n        - board_size (:obj:`int`): The size of the board.\n        - board (:obj:`numpy.ndarray`): The board state.\n    Returns:\n        - outputs (:obj:`Tuple`): Tuple containing 'done' and 'winner',\n            - if player 1 win,     'done' = True, 'winner' = 1\n            - if player 2 win,     'done' = True, 'winner' = 2\n            - if draw,             'done' = True, 'winner' = -1\n            - if game is not over, 'done' = False, 'winner' = -1\n    ";
static PyObject *__pyx_pw_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_1get_done_winner_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int32_t __pyx_v_board_size;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_done_winner_cython (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_board_size,&__pyx_n_s_board,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_board_size)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_board)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_done_winner_cython", 1, 2, 2, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_done_winner_cython") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_board_size = __Pyx_PyInt_As_int32_t(values[0]); if (unlikely((__pyx_v_board_size == ((int32_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_board = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_int32_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_board.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_done_winner_cython", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("zoo.board_games.gomoku.envs.get_done_winner_cython.get_done_winner_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(__pyx_self, __pyx_v_board_size, __pyx_v_board);
...
static PyObject *__pyx_pf_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(CYTHON_UNUSED PyObject *__pyx_self, int32_t __pyx_v_board_size, __Pyx_memviewslice __pyx_v_board) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = __pyx_f_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython(__pyx_v_board_size, __pyx_v_board, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "zoo.board_games.gomoku.envs.get_done_winner_cython.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "zoo.board_games.gomoku.envs.get_done_winner_cython.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "zoo.board_games.gomoku.envs.get_done_winner_cython.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "zoo.board_games.gomoku.envs.get_done_winner_cython._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_done_winner_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_1get_done_winner_cython, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3zoo_11board_games_6gomoku_4envs_22get_done_winner_cython_get_done_winner_cython},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_get_done_winner_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_get_done_winner_cython},
  {0, NULL}
};
#endif
 ...
 *     # iterate through all positions in the board
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_int_1, __pyx_int_neg_1); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_int_1, __pyx_int_0); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__2);
  __Pyx_GIVEREF(__pyx_tuple__2);
  __pyx_tuple__3 = PyTuple_Pack(2, __pyx_int_1, __pyx_int_1); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_tuple__4 = PyTuple_Pack(2, __pyx_int_0, __pyx_int_1); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__4);
  __Pyx_GIVEREF(__pyx_tuple__4);
  __pyx_tuple__5 = PyTuple_Pack(4, __pyx_tuple_, __pyx_tuple__2, __pyx_tuple__3, __pyx_tuple__4); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 23, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initget_done_winner_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initget_done_winner_cython(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_get_done_winner_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_get_done_winner_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_get_done_winner_cython(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'get_done_winner_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_get_done_winner_cython(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("get_done_winner_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_zoo__board_games__gomoku__envs__get_done_winner_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "zoo.board_games.gomoku.envs.get_done_winner_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "zoo.board_games.gomoku.envs.get_done_winner_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "zoo/board_games/gomoku/envs/get_done_winner_cython.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init zoo.board_games.gomoku.envs.get_done_winner_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init zoo.board_games.gomoku.envs.get_done_winner_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_int32_t(PyObject *obj, int writable_flag) {
