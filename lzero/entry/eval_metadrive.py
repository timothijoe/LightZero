...
def eval_metadrive(
    ...
    collector_env = create_env_manager(cfg.env.manager, [partial(wrapped_env, cfg.env.metadrive) for c in collector_env_cfg])
    evaluator_env = create_env_manager(cfg.env.manager, [partial(wrapped_env, cfg.env.metadrive) for c in evaluator_env_cfg])
