...
class SpirlEncoder(nn.Module):
    ...
    def __init__(
            self,
            obs_shape: Union[int, SequenceType] = [5, 200, 200],
            action_shape: Union[int, SequenceType, EasyDict] = 3,
...
class SampledEfficientZeroModel(nn.Module):
    ...
    def __init__(
        ...
        #expert_encoder_ckpt_path = '/home/hunter/obelisk/expert_LightZero/model_path/expcc_60_model'
        #expert_encoder_ckpt_path = '/home/hunter/obelisk/expert_LightZero/result/metadrive_train_expert_testjuly2/ckpt/150_ckpt'
        expert_encoder_ckpt_path = '/home/hunter/obelisk/expert_LightZero/result/metadrive_train_expert_straight_aggresive/ckpt/20_ckpt'
        #expert_encoder_ckpt_path = '/home/hunter/obelisk/expert_LightZero/result/metadrive_train_expert_straight_wild/ckpt/80_ckpt'
        ...
        expert_encoder_ckpt_path = pwd + '/model_path/encoder_60_model'
        expert_encoder_ckpt_path ='/home/rpai_lab_server_1/osiris/debug_lz/result/metadrive_train_expert3/ckpt/150_ckpt'
        expert_encoder_ckpt_path = '/home/rpai_lab_server_1/osiris/debug_lz/result/metadrive_train_expert5_jan08/ckpt/190_ckpt'
        expert_encoder_ckpt_path = '/home/rpai_lab_server_1/osiris/debug_lz/result/metadrive_train_expert5_jan10_expcc/ckpt/70_ckpt'
        
        #expert_encoder_ckpt_path = '/home/rpai_lab_server_1/osiris/debug_lz/result/metadrive_train_expert5_jan11_expcc_lane_chagne/ckpt/30_ckpt'
